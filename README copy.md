# Code for adding dev version of ameya chatbot js plugin as script in your web app

    <!-- Add this line to add ameya chatbot -->
    <script type="text/javascript" src="https://d39ekrw7nlgcar.cloudfront.net/ameya-chatbot-v0.1.0.js"></script>
...
## Base URLs
Token Service : `https://appflyte-backend.smartfoodsafe.net`
Analytics API : `https://dev-api.ameya.ai`


### 1. Generate Agent User Token
Generates authentication token for an agent user. This token must be obtained before making any calls to the Analytics API.
    ...
    Method: POST
    Base URL: https://appflyte-backend.smartfoodsafe.net
...
Retrieves the list of datasets available to the authenticated subscriber. Use the returned dataset metadata when submitting a query.
    ...
    Method: GET
    Base URL: `https://dev-api.ameya.ai
